...
<a href="https://github.com/ThalysRD/Trybe-Futebol-Clube">TrybeFutebolClube</a>: Este projeto se trata de uma plataforma para que o usuário possa acompanhar os resultados dos jogos, tanto os que estão em andamento quanto os que já foram encerrados. Nesse projeto, desenvolvi o backend utilizando TypeScript.
<a href="https://github.com/ThalysRD/POO-SOLID-TS">Trybers and Dragons</a>: O intuito desse projeto foi trabalhar a programação orientada a objetos de uma maneira lúdica, criando um jogo de RPG.
<h2> Habilidades </h2>
